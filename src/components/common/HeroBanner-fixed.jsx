        ...
        <div className="flex items-center justify-center min-h-[600px] lg:min-h-[700px] py-20">
          ...
          <div className="relative">
            ...
            <div className="w-80 h-80 lg:w-96 lg:h-96 bg-white/10 backdrop-blur-xl rounded-full flex items-center justify-center border border-white/20 shadow-2xl relative group">
              ...
              {/* Sistema orbital de suplementos */}
              <div className="absolute inset-0 orbital-system">
                {/* Órbitas */}
                {[1, 2, 3, 4, 5].map((orbit) => (
                  <div key={orbit} className={`orbital-ring orbital-ring-${orbit}`}>
                    <div className={`orbital-element orbital-element-${orbit}`}>
                      <div className="orbital-icon">
                        <SupplementIcons type={orbit === 1 ? "whey" : orbit === 2 ? "creatine" : orbit === 3 ? "preworkout" : orbit === 4 ? "vitamins" : "bcaa"} />
                      </div>
                    </div>
                  </div>
                ))}
